...
if args.m0:
    ...
    if len(directory.split())==2:
        ...
        infiles_2 = infile_append(directory,0,infiles_2)
    ...
    df = df1.join(df2)
    df.columns = ["model0_w","model0_BEB_sites","background_w","foreground_w","model2_BEB_sites"]
    df.to_csv("{}.csv".format(csv_name),sep="\t")
